...
struct _Controller {
	...
	struct list_head	controllerlist;
...
#define PLCI_STATE_DISCONNECT_IND	6
...
int ContrAllocFreeChannel(Controller_t *, unsigned char);
void ContrFreeChannel(Controller_t *, int);
...
u_int plci_parse_channel_id(u_char *);
