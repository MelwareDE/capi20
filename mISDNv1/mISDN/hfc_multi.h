...
#define HFC_outl(a,b,c) (*((volatile u_long *)((a->pci_membase)+((b)*ADDR_MULT))) = cpu_to_le32(c))
#define HFC_inl(a,b) le32_to_cpu((*((volatile u_long *)((a->pci_membase)+((b)*ADDR_MULT)))))
...
#define HFC_outw_(a,b,c) (*((volatile u_short *)((a->pci_membase)+((b)*ADDR_MULT))) = cpu_to_le16(c))
#define HFC_inw_(a,b) le16_to_cpu((*((volatile u_short *)((a->pci_membase)+((b)*ADDR_MULT)))))
/*
